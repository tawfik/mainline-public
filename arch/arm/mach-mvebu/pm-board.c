...
static void const __iomem *gpio_ctrl_addr[ARMADA_XP_GP_PIC_NR_GPIOS];
...
static void mvebu_armada_xp_gp_pm_enter(void __iomem *sdram_reg, u32 srcmd)
{
	...
	/*
	 * This code assumes that the ack bits (#1 and possibly #2)
	 * belong to the same GPIO group
	 */
...
static int mvebu_armada_xp_gp_pm_init(void)
{
	...
	if (!of_machine_is_compatible("marvell,axp-gp") &&
	    !of_machine_is_compatible("marvell,a385-gp"))
		return -ENODEV;
